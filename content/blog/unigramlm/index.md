...
probability mass transfers to its best alternative Viterbi segmentation
(notably, pieces that do not appear in the current Viterbi segmentation
of the corpus are pre-pruned). Third, SentencePiece does not use the
...
$\log {\phi\_{v}}$ under a Dirichlet posterior. Intuitively, this
"softens" the update by damping very large counts and preventing rare
